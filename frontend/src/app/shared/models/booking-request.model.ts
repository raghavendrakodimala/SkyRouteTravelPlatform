...
/**
 * The "flight" object nested in a POST /api/bookings request — the full flight-detail
...
/** POST /api/bookings request body — docs/features/feature-booking-flow.md Section 3. */
...
/**
 * The "flight" object nested in a POST /api/bookings 201 response — matches the backend's
...
/** POST /api/bookings 201 response body — docs/features/feature-booking-flow.md Section 4. */

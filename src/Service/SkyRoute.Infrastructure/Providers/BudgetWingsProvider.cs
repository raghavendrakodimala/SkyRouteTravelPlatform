...
public sealed class BudgetWingsProvider : IFlightProvider
{
    ...
    private static readonly IReadOnlyList<ProviderScheduleMapper.ScheduledFlight> FixedSchedule = new List<ProviderScheduleMapper.ScheduledFlight>
    {
    ...
    /// provider's own schedule (fixtures + generated routes — a booking made on a generated
    /// flight must resolve exactly like a fixture one), applying the exact same cabin multiplier and
